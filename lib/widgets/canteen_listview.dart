...
class CanteenListview extends StatefulWidget {
  const CanteenListview(this.selectionChangedCallback,
      {Key? key, required this.canteens,})
      : super(key: key);
...
class _CanteenListviewState extends State<CanteenListview> {
  ...
  Widget build(BuildContext context) {
    return widget.canteens.isNotEmpty
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      setState(() {
                        ...
                        widget.selectionChangedCallback(_selectedIndex > -1
                            ? widget.canteens[_selectedIndex]
                            : null);
                      });
                    },
                  ),
        ...
        : const Center(
            child: Text('No canteens currently'),
          );
  }
}
